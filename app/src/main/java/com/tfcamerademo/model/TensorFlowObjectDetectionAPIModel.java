...
public class TensorFlowObjectDetectionAPIModel implements Classifier {
    ...
    private TensorFlowLiteInferenceInterface inferenceInterface;
    ...
    public static Classifier create(
        ...
        d.inferenceInterface = new TensorFlowLiteInferenceInterface(assetManager, modelFilename);
    ...
    public List<Recognition> recognizeImage(final Bitmap bitmap) {
        ...
        inferenceInterface.feed(d.inputName, byteValues, 1, inputSize, inputSize, 3);
        Trace.endSection();
